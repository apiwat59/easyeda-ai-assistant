[Simplified Chinese](./README.md) | [English](./README.md) | [Traditional Chinese](./README.zh-Hant.md) | [Japanese](#) | [Russian](./README.ru.md)

# pro-api-sdk

JLCEDA & EasyEDA Pro Edition API 開発ツール
...
この開発ツールグループは、[Apache License 2.0](https://choosealicense.com/licenses/apache-2.0/) オープンソースライセンス契約を使用しており、このツールグループに基づいて開発された拡張パッケージの **機能説明部分** および **オープンソースリリースタイトル部分** の **JLCEDA**、**EasyEDA** 商標情報のみを使用することができます。
